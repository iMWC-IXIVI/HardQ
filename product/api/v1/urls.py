...
from api.v1.views.course_view import CourseViewSet, GroupViewSet, LessonViewSet, CourseExampleViewSet, PayExampleViewSet
...
v1_router.register('pay', PayExampleViewSet, basename='pay')
